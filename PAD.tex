...
Ultrabright light sources such as free-electron lasers \cite{seddon_short-wavelength_2017} and table-top laser systems based on high-order harmonic generation \cite{popmintchev_attosecond_2010,chini_generation_2014} deliver high-intensity pulses of few- or sub-femtosecond duration. Nowadays, laser pulses with a duration of a few tens of attoseconds have been achieved experimentally \cite{zhao_attosecond_2012,chen_generation_2014}. Isolated attosecond pulses or trains of attosecond pulses have been generated from the vacuum ultraviolet to the soft X-ray wavelength regime and the polarization of such pulses can nowadays be controlled. This recent progress in ultrafast laser pulse technology makes it possible to probe, steer and control the dynamics of electrons in atoms, molecules and solids \cite{vrakking_attosecond_2014,Pazourek2015,calegari_advances_2016,xu_time-resolved_2016,ramasesha_real-time_2016,peng_attosecond_2019}.
To name a few examples, the time-resolved measurement of the electron emission in the photoelectric effect has been realized \cite{cavalieri_attosecond_2007,schultze_delay_2010,klunder2011, tao_direct_2016,isinger_photoionization_2017}. Using an isolated attosecond pulse or a train of extreme-ultraviolet attosecond pulses to ionize an atom along with an infrared laser field interferograms have been measured to obtain information about phases of electron wavepackets, an important milestone towards reconstructing the wavefunctions of atoms \cite{remetter_attosecond_2006,Mauritsson2010}. By extracting the phase and amplitude via application of photoelectron spectroscopy recently the birth of a photoelectron through a Fano resonance has been observed on the attosecond time scale \cite{gruson_attosecond_2016}.

Probing atoms and molecules in their ground or excited states with ultrashort laser pulses opens a new regime where several linear and nonlinear ionization pathways compete and interfere \cite{PhysRevLett.108.033003,ma_photoelectron_2013,grum-grzhimailo_interfering_2015,douguet_photoelectron_2016,hofbrucker_maximum_2018,boll_angularly_2019,wang_time-dependent_2019,venzke_ionization_2020}. For example, it has been shown how the competition between resonant and nonresonant pathways depends on the pulse width \cite{PhysRevLett.108.033003}. An important observable are photoelectron angular distributions (PAD), which are measured by detecting the probability for emission of the electron from the target in different directions. Since PADs are determined by the amplitudes and phases of the partial waves of all pathways contributing to the emission, they are practical means to identify the different contributing pathways. A characteristic signature of such interferences are asymmetries in the emission of the photoelectron \cite{yin_asymmetric_1992}. In the simple case of photoionization from a single state, anisotropy and asymmetry parameters have been used in the past to identify and analyze interesting physical effects. A significant circular dichroism via the asymmetry in the forward-backward electron emission from bromocamphor molecules induced by circularly polarized light has been identified  \cite{bowering_asymmetry_2001}. Observation of the breakdown of the symmetry in the photoelectron emission of argon has been shown in the region of the Cooper minimum \cite{ilchen_symmetry_2018}. Interferences between resonant and non-resonant pathways \cite{PhysRevLett.108.033003} or direct and autoionizing channels \cite{cirelli_anisotropic_2018} can be identified via anisotropy and asymmetry parameters. Other examples can be found in double photoionization \cite{maulbetsch_asymmetry_1992} or molecular vibrations and chirality \cite{garcia_vibrationally_2013} and applications range from studies of coherent control \cite{prince_coherent_2016} to the characterization of ultrashort laser pulses \cite{chelkowski_sensitivity_2002}.
...
It has been shown \cite{laplanche86} that the photoelectron angular distribution for an isotropic target is given by: 
%
\begin{equation}
\label{beta}
...
We consider a prototypical example in ultrafast science and, more general, in atomic physics, which is schematically shown in Fig.~\ref{fig:scheme}. 
...
The availability of attosecond light sources at wavelengths from the vacuum ultraviolet (VUV) and extreme ultraviolet (EUV) to the soft X-ray regime via the technologies of free electron lasers (FEL) \cite{seddon_short-wavelength_2017} and high-order harmonic generation (HHG) \cite{popmintchev_attosecond_2010,chini_generation_2014} has opened a new regime of ultrafast measurements in atomic and molecular physics. Laser pulses of duration as short as a few tens of attoseconds have been demonstrated experimentally \cite{zhao_attosecond_2012,chen_generation_2014} and enabled the observation of electron dynamics (for recent reviews, see \cite{vrakking_attosecond_2014,Pazourek2015,calegari_advances_2016,ramasesha_real-time_2016,young_roadmap_2018,peng_attosecond_2019}). One example is the time-resolved measurement of the photoelectric effect in atoms and solids \cite{cavalieri_attosecond_2007,schultze_delay_2010,klunder2011,tao_direct_2016,isinger_photoionization_2017}. Electron emission from the target has been also temporally resolved for a transition of the electron into the continuum through excited state resonances \cite{su2015,Sabbar2015,Gong2017}, autoionizing states \cite{jimenez2014,Dolmatov2015,Barreau2019}, Fano resonances \cite{kaldun_observing_2016,kotur_spectral_2016,gruson_attosecond_2016,cirelli_anisotropic_2018} and for correlated electron emission \cite{pfeiffer_timing_2011,Pazourek2012,mansson_double_2014}. Electron wavepacket dynamics in superposition states of atoms and molecules has been another focus of attosecond time-resolved studies, either for single valence electron motion \cite{goulielmakis_real-time_2010,Mauritsson2010,holler2011,hockett_time-resolved_2011,Kim2012,xie2012,klunder2013,beck_attosecond_2014,hassan_optical_2016,walt_dynamics_2017,priebe_attosecond_2017,He2018} or correlated two-electron dynamics \cite{hu2006,feist2011,ott_reconstruction_2014}.
